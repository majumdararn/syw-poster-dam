...
with g.subgraph(name='cluster_group2') as c2:
    c2.attr(label="Overleaf", fontsize=fs_big, labelloc="t", labeljust="l")
...
with g.subgraph(name='cluster_group3') as c3:
    c3.attr(label="Overleaf", fontsize=fs_big, labelloc="t", labeljust="l")
...
with g.subgraph(name='cluster_group4') as c4:
    c4.attr(label="Overleaf", fontsize=fs_big, labelloc="t", labeljust="l")
